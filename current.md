...
![basic deployment diagram for VPC based environments](/images/current-guidance.drawio.svg){: caption="Basic deployment diagram for VPC based environments" caption-side="bottom"}
